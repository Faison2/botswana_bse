        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildQuickStat('Open', 'BWP ${stock['OpeningPrice'] ?? 'N/A'}', subtextColor, textColor),
                _buildQuickStat('High', 'BWP ${stock['MaxPrice'] ?? 'N/A'}', subtextColor, textColor),
                _buildQuickStat('Low', 'BWP ${stock['MinPrice'] ?? 'N/A'}', subtextColor, textColor),
              ],
            ),
          ],
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                _buildStatRow('Day Range',
                    'BWP ${widget.stock['dayLow']?.toStringAsFixed(2)} - ${widget.stock['dayHigh']?.toStringAsFixed(2)}',
                    textColor, subtextColor),
                const SizedBox(height: 12),
                _buildStatRow('52 Week Range',
                    'BWP ${widget.stock['weekLow52']?.toStringAsFixed(2)} - ${widget.stock['weekHigh52']?.toStringAsFixed(2)}',
                    textColor, subtextColor),
                const SizedBox(height: 12),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _buildDetailRow('Maximum Price', '  BWP ${widget.stock['MaxPrice'] ?? 'N/A'}', textColor, subtextColor),
                  const SizedBox(height: 12),
                  _buildDetailRow('Minimum Price', 'BWP ${widget.stock['MinPrice'] ?? 'N/A'}', textColor, subtextColor),
                ],
              ),
            ),
            const SizedBox(height: 16),
