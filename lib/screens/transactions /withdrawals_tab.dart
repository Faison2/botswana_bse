...
class WithdrawalsTab extends StatefulWidget {
  ...
  const WithdrawalsTab({Key? key, required this.isDark}) : super(key: key);
...
class _WithdrawalsTabState extends State<WithdrawalsTab> {
  ...
  final TextEditingController _descriptionController = TextEditingController(text: 'Emergency Funds');
